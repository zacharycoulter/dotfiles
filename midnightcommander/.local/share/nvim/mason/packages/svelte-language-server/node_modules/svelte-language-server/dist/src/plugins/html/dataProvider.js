...
const svelteTags = [
    ...
    {
        name: 'svelte:html',
        description: 'This element allows you to add properties and listeners to events on `document.documentElement`. This is useful for attributes such as `lang` which influence how the browser interprets the content.',
        attributes: []
    },
    {
...
const originalProvideAttributes = exports.svelteHtmlDataProvider.provideAttributes.bind(exports.svelteHtmlDataProvider);
exports.svelteHtmlDataProvider.provideAttributes = (tag) => {
